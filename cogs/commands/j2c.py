...
class ControlPanelView(ui.View):
    ...
    @ui.button(label="WAITING ROOM", style=discord.ButtonStyle.blurple, row=0, custom_id="j2c:waiting", emoji=" ")
    ...
    @ui.button(label="INVITE", style=discord.ButtonStyle.green, row=1, custom_id="j2c:invite", emoji=" ")
    ...
    @ui.button(label="DELETE", style=discord.ButtonStyle.red, row=2, custom_id="j2c:delete", emoji=" ")
